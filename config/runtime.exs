...
#
#     PHX_SERVER=true bin/pokevestment start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :pokevestment, PokevestmentWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :pokevestment, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  config :pokevestment, PokevestmentWeb.Endpoint,
    url: [host: host, port: String.to_integer(System.get_env("PORT") || "4006"), scheme: "http"],
    http: [
